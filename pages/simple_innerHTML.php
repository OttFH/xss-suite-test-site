        ...
        <div class="vulnerability-info-container">
            ...
            <?php if (!getenv('HIDE_EXAMPLES') || getenv('HIDE_EXAMPLES') != 'true') { ?>
                <button onclick="window.location = String.fromCharCode(47,112,97,103,101,115,47,115,105,109,112,108,101,
                    95,105,110,110,101,114,72,84,77,76,46,112,104,112,63,120,115,115,61,60,105,109,103,32,115,114,99,61,
                    47,105,109,103,47,120,115,115,45,109,101,109,101,46,106,112,103,32,111,110,108,111,97,100,61,97,108,
                    101,114,116,40,49,41,32,47,62)">
                    Example
                </button>
            <?php } ?>
        </div>
